...
input_size_seconds = 4
pretrained_model = "/FADE-ECG/pretrained_models/domain_adapted_model.pt"
model = slowfast_raw(dropout=0, num_channels=1, layer_norm=False,
                             stochastic_depth=0, add_FC_BN=False, remove_BN=False, add_FC=True,
